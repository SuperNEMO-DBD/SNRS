...
##########################################################################
[name="snemo_pad_copper.fake.model" type="geomtools::simple_shaped_model"]
...
[name="snemo_strip_copper.fake.model" type="geomtools::simple_shaped_model"]
  ...
  internal_item.model.pad0      : string = "snemo_pad_copper.fake.model"
  internal_item.placement.pad0  : string = "0 0 0 (mm) "
  mapping.daughter_id.strip     : string = "[source_pad:pad=0]"


[name="snemo_strip_path_copper.fake.model" type="geomtools::simple_shaped_model"]
  shape_type   : string = "box"
  ...
  internal_item.model.strip      : string = "snemo_strip_copper.fake.model"
  internal_item.placement.strip  : string = "0 0 0 (mm) "
  mapping.daughter_id.strip      : string = "[source_strip]"


########################################################################
[name="snemo_pad_lapp.fake.model" type="geomtools::simple_shaped_model"]
  shape_type   : string = "box"
...
[name="snemo_strip_lapp.fake.model" type="geomtools::simple_shaped_model"]
  ...
  y            : real as length = 135.5 mm
  z            : real as length = 2800.0 mm
  material.ref : string = "tracking_gas"
  internal_item.labels : string[1] =  "pad0"
  internal_item.model.pad0      : string = "snemo_pad_lapp.fake.model"
  internal_item.placement.pad0  : string = "0 0 0 (mm) "
  mapping.daughter_id.pad0      : string = "[source_pad:pad=0]"


[name="snemo_strip_path_lapp.fake.model" type="geomtools::simple_shaped_model"]
  shape_type   : string = "box"
  x            : real as length = 58.0 mm
  y            : real as length = 135.5 mm
  z            : real as length = 3000.0 mm
  material.ref : string = "tracking_gas"
  internal_item.labels : string[1] =  "strip"
  internal_item.model.strip      : string = "snemo_strip_lapp.fake.model"
  internal_item.placement.strip  : string = "0 0 0 (mm) "
  mapping.daughter_id.strip      : string = "[source_strip]"


#############################################################################
[name="snemo_pad_flat_itep.fake.model" type="geomtools::simple_shaped_model"]
  shape_type   : string = "box"
  x            : real as length = 250.0 um
  y            : real as length = 135.5 mm
  z            : real as length = 2700.0 mm
...
[name="snemo_strip_flat_itep.fake.model" type="geomtools::simple_shaped_model"]
  ...
  material.ref : string = "mix_selenium"
  internal_item.labels : string[1] =  "pad0"
  internal_item.model.pad0      : string = "snemo_pad_flat_itep.fake.model"
  internal_item.placement.pad0  : string = "0 0 0 (mm) "
  mapping.daughter_id.pad0      : string = "[source_pad:pad=0]"


[name="snemo_strip_path_flat_itep.fake.model" type="geomtools::simple_shaped_model"]
  shape_type   : string = "box"
  x            : real as length = 58.0 mm
  y            : real as length = 135.5 mm
  z            : real as length = 3000.0 mm
  material.ref : string = "tracking_gas"
  internal_item.labels : string[1] =  "strip"
  internal_item.model.strip      : string = "snemo_strip_flat_itep.fake.model"
  internal_item.placement.strip  : string = "0 0 0 (mm) "
  mapping.daughter_id.strip      : string = "[source_strip]"
...
[name="snemo_source_submodule.model" type="geomtools::simple_shaped_model"]
  ...
  internal_item.model.strip_0      : string = "snemo_strip_path_copper.fake.model"
  internal_item.placement.strip_0  : string = "0 -2434.5 0 (mm) "

  internal_item.model.strip_1      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_1  : string = "0 -2303.25 0 (mm) "

  internal_item.model.strip_2      : string = "snemo_strip_path_flat_itep.fake.model"
  internal_item.placement.strip_2  : string = "0 -2166.75 0 (mm) "

  internal_item.model.strip_3      : string = "snemo_strip_path_3.realistic.model"
  internal_item.placement.strip_3  : string = "0 -2013.25 0 (mm) "

  internal_item.model.strip_4      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_4  : string = "0 -1876.75 0 (mm) "

  internal_item.model.strip_5      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_5  : string = "0 -1740.25 0 (mm) "

  internal_item.model.strip_6      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_6  : string = "0 -1603.75 0 (mm) "

  internal_item.model.strip_7      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_7  : string = "0 -1467.25 0 (mm) "

  internal_item.model.strip_8      : string = "snemo_strip_path_8.realistic.model"
  internal_item.placement.strip_8  : string = "0 -1330.75 0 (mm) "

  internal_item.model.strip_9      : string = "snemo_strip_path_9.realistic.model"
  internal_item.placement.strip_9  : string = "0 -1177.25 0 (mm) "

  internal_item.model.strip_10      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_10  : string = "0 -1040.75 0 (mm) "

  internal_item.model.strip_11      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_11  : string = "0 -904.25 0 (mm) "

  internal_item.model.strip_12      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_12  : string = "0 -767.75 0 (mm) "

  internal_item.model.strip_13      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_13  : string = "0 -631.25 0 (mm) "

  internal_item.model.strip_14      : string = "snemo_strip_path_14.realistic.model"
  internal_item.placement.strip_14  : string = "0 -494.75 0 (mm) "

  internal_item.model.strip_15      : string = "snemo_strip_path_15.realistic.model"
  internal_item.placement.strip_15  : string = "0 -341.25 0 (mm) "

  internal_item.model.strip_16      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_16  : string = "0 -204.75 0 (mm) "

  internal_item.model.strip_17      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_17  : string = "0 -68.25 0 (mm) "

  internal_item.model.strip_18      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_18  : string = "0 68.25 0 (mm) "

  internal_item.model.strip_19      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_19  : string = "0 204.75 0 (mm) "

  internal_item.model.strip_20     : string = "snemo_strip_path_20.realistic.model"
  internal_item.placement.strip_20 : string = "0 341.25 0 (mm) "

  internal_item.model.strip_21     : string = "snemo_strip_path_21.realistic.model"
  internal_item.placement.strip_21 : string = "0 494.75 0 (mm) "

  internal_item.model.strip_22     : string = "snemo_strip_path_22.realistic.model"
  internal_item.placement.strip_22 : string = "0 631.25 0 (mm) "

  internal_item.model.strip_23     : string = "snemo_strip_path_23.realistic.model"
  internal_item.placement.strip_23 : string = "0 767.75 0 (mm) "

  internal_item.model.strip_24     : string = "snemo_strip_path_24.realistic.model"
  internal_item.placement.strip_24 : string = "0 904.25 0 (mm) "

  internal_item.model.strip_25     : string = "snemo_strip_path_25.realistic.model"
  internal_item.placement.strip_25 : string = "0 1040.75 0 (mm) "

  internal_item.model.strip_26     : string = "snemo_strip_path_26.realistic.model"
  internal_item.placement.strip_26 : string = "0 1177.25 0 (mm) "

  internal_item.model.strip_27     : string = "snemo_strip_path_27.realistic.model"
  internal_item.placement.strip_27 : string = "0 1330.75 0 (mm) "

  internal_item.model.strip_28     : string = "snemo_strip_path_28.realistic.model"
  internal_item.placement.strip_28 : string = "0 1467.25 0 (mm) "

  internal_item.model.strip_29      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_29  : string = "0 1603.75 0 (mm) "

  internal_item.model.strip_30      : string = "snemo_strip_path_lapp.fake.model"
  internal_item.placement.strip_30  : string = "0 1740.25 0 (mm) "

  internal_item.model.strip_31     : string = "snemo_strip_path_31.realistic.model"
  internal_item.placement.strip_31 : string = "0 1876.75 0 (mm) "
  
  internal_item.model.strip_32     : string = "snemo_strip_path_32.realistic.model"
  internal_item.placement.strip_32 : string = "0 2013.25 0 (mm) "

  internal_item.model.strip_33     : string = "snemo_strip_path_33.realistic.model"
  internal_item.placement.strip_33 : string = "0 2166.75 0 (mm) "

  internal_item.model.strip_34     : string = "snemo_strip_path_34.realistic.model"
  internal_item.placement.strip_34 : string = "0 2303.25 0 (mm) "

  internal_item.model.strip_35     : string = "snemo_strip_path_copper.fake.model"
